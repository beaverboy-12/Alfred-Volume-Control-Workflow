...
The final configuration allows you to determine the sound played upon completion. By default this is a "ping" however with the configuration you can optionally replace this with a voiceover of the current volume set or mute it altogether.
